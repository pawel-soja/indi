...
bool WeatherWatcher::createPropertiesFromMap()
{
    ...
    for (auto const &x : weatherMap)
    {
        ...
        else if (x.first == keywordTP[1].text)
        {
            minOK = -10;
            maxOK = 30;
            percWarn = 15;
        ...
        else if (x.first == keywordTP[2].text)
        {
            minOK = 0;
            maxOK = 20;
            percWarn = 15;
        ...
        else if (x.first == keywordTP[3].text)
        {
            minOK = 0;
            maxOK = 20;
            percWarn = 15;
        ...
        else if (x.first == keywordTP[4].text)
        {
            minOK = 0;
            maxOK = 20;
            percWarn = 15;
        ...
        else if (x.first == keywordTP[5].text)
        {
            minOK = 0;
            maxOK = 100;
            percWarn = 15;
        ...
        else if (x.first == keywordTP[6].text)
        {
            minOK = 983;
            maxOK = 1043;
            percWarn = 15;
        ...
        else if (x.first == keywordTP[7].text)
        {
            minOK = 0;
            maxOK = 0;
            percWarn = 15;
...
bool WeatherWatcher::readWatchFile()
{
    ...
    if (std::string(watchFileTP[0].text).find("http") == 0)
        snprintf(requestURL, MAXRBUF, "%s", watchFileTP[0].text);
    else
        snprintf(requestURL, MAXRBUF, "file://%s", watchFileTP[0].text);
