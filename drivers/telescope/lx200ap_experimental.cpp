...
bool LX200AstroPhysicsExperimental::ISNewNumber(const char *dev, const char *name, double values[], char *names[], int n)
{
    ...
    if (HourangleCoordsNP.isNameMatch(name))
    {
        ...
        double lng = LocationNP[LOCATION_LONGITUDE].value;
        double lst = get_local_sidereal_time(lng);
        double ra = lst - HourangleCoordsNP[0].value;
        double dec = HourangleCoordsNP[1].value;
        bool success = false;
...
bool LX200AstroPhysicsExperimental::IsMountInitialized(bool *initialized)
{
    ...
    if (isSimulation())
    {
        ...
        dec = LocationNP[LOCATION_LATITUDE].value > 0 ? 90 : -90;
    }
...
bool LX200AstroPhysicsExperimental::calcParkPosition(ParkPosition pos, double *parkAlt, double *parkAz)
{
    switch (pos)
    {
        ...
        case 1:
            ...
            *parkAlt = 0;
            *parkAz = LocationNP[LOCATION_LATITUDE].value > 0 ? 359.1 : 180.1;
            break;
        ...
        case 3:
            ...
            *parkAz = LocationNP[LOCATION_LATITUDE].value > 0 ? 0.1 : 179.9;
        ...
        case 4:
            ...
            *parkAlt = 0;
            *parkAz = LocationNP[LOCATION_LATITUDE].value > 0 ? 180.1 : 359.1;
            break;
...
bool LX200AstroPhysicsExperimental::SetTrackMode(uint8_t mode)
{
    ...
    if (mode == TRACK_CUSTOM)
    {
        ...
        return SetTrackRate(TrackRateNP[AXIS_RA].value, TrackRateNP[AXIS_DE].value);
    }
