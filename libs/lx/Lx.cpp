...
bool Lx::startLxSerial()
{
    ...
    {
        case 0:
            serialfd = openserial(LxPortTP[0].text);
            if (serialfd < 0)
                return false;
        ...
        case 2:
            ...
            ret = write(serialfd, LxStartStopCmdTP[0].getText(), strlen(LxStartStopCmdTP[0].text));
...
int Lx::stopLxSerial()
{
    ...
    switch (index)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            ret = write(serialfd, LxStartStopCmdTP[1].getText(), strlen(LxStartStopCmdTP[1].text));
            eol = getSerialEOL();
            ret = write(serialfd, eol, strlen(eol));
            break;
    }
